...
-- ============================================================
-- 1) 김성균 · 남 · 22 · 소프트웨어융합대학 · 비흡연 · 부지런+깔끔+예민+예산빠듯
-- ============================================================
...
insert into public.lifestyle_profiles (
  ...
  'a89e769e-bcb6-41e6-8318-c33ba1b898d6',
...
-- ============================================================
-- 2) 이하늘 · 여 · 21 · 경영대학 · 비흡연 · 부지런+깔끔+무던+예산여유
-- ============================================================
insert into public.profiles (id, email, name, gender, age, college, is_smoker, is_demo)
values ('d4487974-2de9-4279-a798-8de813c8858c', 'demo2@g.skku.edu', '이하늘', 'female', 21, '경영대학', false, true)
on conflict (id) do update set
  name = excluded.name, gender = excluded.gender, age = excluded.age,
  college = excluded.college, is_smoker = excluded.is_smoker, is_demo = true;
...
insert into public.lifestyle_profiles (
  ...
  'd4487974-2de9-4279-a798-8de813c8858c',
...
-- ============================================================
-- 3) 박지훈 · 남 · 23 · 전자전기공학부 · 흡연 · 게으름+너저분+예민+예산빠듯
-- ============================================================
insert into public.profiles (id, email, name, gender, age, college, is_smoker, is_demo)
values ('0d39e1ed-140c-4431-bb4e-971adeeff815', 'demo3@g.skku.edu', '박지훈', 'male', 23, '전자전기공학부', true, true)
on conflict (id) do update set
  name = excluded.name, gender = excluded.gender, age = excluded.age,
  college = excluded.college, is_smoker = excluded.is_smoker, is_demo = true;
...
insert into public.lifestyle_profiles (
  ...
  '0d39e1ed-140c-4431-bb4e-971adeeff815',
...
-- ============================================================
-- 4) 최유진 · 여 · 20 · 글로벌바이오메디컬공학과 · 비흡연 · 부지런+깔끔+예민+예산여유
-- ============================================================
insert into public.profiles (id, email, name, gender, age, college, is_smoker, is_demo)
...
insert into public.lifestyle_profiles (
  ...
  'fa32bea6-b16a-40ee-8832-40af989bf3e4',
